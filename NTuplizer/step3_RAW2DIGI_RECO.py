...
# with command line options: step3 --conditions auto:run3_data_prompt_relval -s RAW2DIGI,RECO --datatier DIGI --eventcontent RECO --data --process reRECO --scenario pp --era Run3 --customise Configuration/DataProcessing/RecoTLR.customisePostEra_Run3 -n 100
